...
(function() {
  ...
  _.filter = function(collection, test, context) {
    var arr = [];
      _.each(collection, function(value, index, list) {
        test.call(context, value, index, list) && arr.push(value);
      });
      return arr;
  };
  ...
  _.uniq = function(array) {
    return _.filter(array, function (value, index, context){
      return _.indexOf(context, value) === index;
    });
  };
  ...
  _.invoke = function(collection, functionOrKey, args) {
    var checkFunc = function(func){
      return Object.prototype.toString.call(func) === '[object Function]';
    };
    return _.map(collection, function (value){
      return (checkFunc(functionOrKey) ? functionOrKey : value[functionOrKey]).apply(value, args);
    });
